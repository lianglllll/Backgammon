...
public class 半夏 : Chess
{
    // Start is called before the first frame update
    void Start()
    {
        chessType = ChessType.半夏;
        extraNumber = 0;
    ...
    */
    public override void PrepareMove()
    {
        ...
        if (BattleManager.Instance.IsExistTargetChessTypeByID(nowPosition, ChessType.陈皮))
        {
            相须();
        }
    ...
    public override void LastMove()
    {
        ...
        if(blockStatus== ChessBlockStatus.弱棋)
        {
            ...
            aimchess.GetComponent<Chess>().Harm();
